...
print("log_loss ", log_loss(y_test, knn.predict_proba(X_test_scaled)))
...
logit_roc_auc = roc_auc_score(y_test, knn.predict(X_test_scaled))
...
sentiments = knn.predict(X_totest_scaled)
